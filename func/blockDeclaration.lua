...
function blockDeclaration.declareBlocks()
	...
	blockDeclaration.declareBlock("oakBark", "oakLog", 3, "axe", {{item="oakWood", prob=1},{item="oakBark", prob=5}}, true)
	...
	blockDeclaration.declareBlock("leaves", "oakLeaves", 2, "shears", {{item="oakSapling", prob=2},{item="apple", prob=5}}, true)
