function love.conf(t)
    t.identity = ".minicraft"           -- The name of the save directory (string)
    t.version = "0.10.1"                -- The LÖVE version this game was made for (string)
    t.console = true                    -- Attach a console (boolean, Windows only)

    t.window.title = "Minicraft"        -- The window title (string)
    t.window.icon = "assets/minicraftIcon.png" -- Filepath to an image to use as the window's icon (string)
